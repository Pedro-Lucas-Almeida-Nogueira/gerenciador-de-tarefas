...
from .views import UsuarioApiView, TarefaApiView, UsuariosApiView, TarefasApiView
...
urlpatterns = [
    ...
    path("usuarios/<int:pk>/tarefas/<int:pk_tarefa>", TarefaApiView.as_view(), name="usuario-tarefa"),
